...
mpg %>%
  ...
  geom_hdr_boxplot()
```
- create separate HDR boxplots for different groups
- shade mapped to probability
- color mapped to groups
- cars with 6 cylinders are bimodally distributed
]

.pull-right[
```{r geom-hdr-boxplot-group}
```
]
---
